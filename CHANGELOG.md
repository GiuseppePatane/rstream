...
Update for 0.40.0
- Change git-cliff action to orhun version 4.6.0
- Command usage for git-cliff in workflow
...
Signed-off-by: Gabriele Santomaggio <G.santomaggio@gmail.com>
- Versioning and changelog generation steps
